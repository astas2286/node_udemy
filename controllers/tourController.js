...
///tours-within/233/center/34.025055,-118.112922/unit/mi
    ...
    const distances = await Tour.aggregate([
        {
            $geoNear: {
                ...
                distanceMultiplier: multiplier // to set the distance in km or miles
            }
        },
        {
            $project: { // to show only distance and name in output
                distance: 1,
                name: 1
            }
        }
