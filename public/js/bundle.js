      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Logged in succsessfully!');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status = 'success') {
            (0, _alerts.showAlert)('success', "".concat(type, " updated succsessfully!"));
          }
          console.log(res);
          _context.next = 12;
          break;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51MqYdHDJgbb5tAFAXkoMk2NG8hWuCWB343qm7ABwADRC5bN2QOTomyNewfGICKO4QdMj3pTNJFatAO4SV9A9Lxzq00KLVTsXXD'); //1) get checkout session from API
          _context.next = 4;
